...
const buscarString = (string, array) => {
...
console.log(buscarPalavrasSemelhantes("lin", ["lindeza", "linda", "Maravilhosa"]))


//Resolução 2
function buscarPalavrasSemelhantes(inicio, palavras) {
  return palavras.filter(palavra => palavra.includes(inicio)) // O método includes() determina se um array contém um determinado elemento,
